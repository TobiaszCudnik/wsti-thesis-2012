...
describe 'Signals', ->
	...
	describe 'mixin basics', ->
		...
		it 'should auto init signals', ->
			obj.initSignals()
			expect( spies.init.called ).to.be.ok()
	...
	describe 'objects', ->
		it 'should override signal from a super class', ->
		it 'should allow merge listener', ->
